...
import { ${this.generateAutoGeneratedInterfaceName(resource)} } from "./${this.generateGeneratedDirectory()}/${this.generateInterfaceName(resource)}"

export interface ${this.generateInterfaceName(resource)} extends ${this.generateAutoGeneratedInterfaceName(resource)} {
}

export namespace ${this.generateNamespaceName(resource)} {
    export function newResource(type?: string): ${this.generateInterfaceName(resource)} {
        return {
            ...${this.generateAutoGeneratedNamespaceName(resource)}.newResource('${resource}'),
        }
    }
}
...
export interface ${this.generateAutoGeneratedInterfaceName(resource)} extends ${this.prefix}Resource {
...
export namespace ${this.generateAutoGeneratedNamespaceName(resource)} {
    export function newResource(type: string): ${this.generateAutoGeneratedInterfaceName(resource)} {
        return {
...
export class ${this.generateAutoGeneratedClassName(resource)} {
    static new(): ${this.generateAutoGeneratedInterfaceName(resource)} {
        return ${this.generateAutoGeneratedNamespaceName(resource)}.newResource('${resource}')
    }
}

export default ${this.generateAutoGeneratedClassName(resource)}
`
        return contents
    }
    ...
    namespaceAttributeAssignment = (resource, name, attribute) => {
        ...
        else if (attribute.type === 'object') return `${this.toCamelCase(name)}: ${this.generateAutoGeneratedNamespaceName(resource)}.${this.namespaceFunctionName(name)}()`
