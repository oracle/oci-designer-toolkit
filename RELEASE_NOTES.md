...
____
Welcome to the March 2025 release of OKIT. This release extends both import and export functions of the OCD Desktop release whilst adding token based authentication.
...
1. OKIT-320: Import Terraform Files. This is the initial release of the Terraform import functionality and may need updates as and when issues are seen.
