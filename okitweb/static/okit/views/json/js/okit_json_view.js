...
*/
console.debug('Loaded OKIT Json View Javascript');
...
class OkitCacheJsonView extends OkitTextJsonView {
    constructor(okitjson=null, oci_data=null, resource_icons=[], parent_id = 'json-text-div') {
        super(null, oci_data, resource_icons, parent_id);
    ...
    static newView(model, oci_data=null, resource_icons=[], parent_id = 'json-text-div') {
        return new OkitCacheJsonView((model, oci_data, parent_id, resource_icons))
    }
