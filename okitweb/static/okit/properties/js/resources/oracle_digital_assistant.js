...
*/
console.info('Loaded OracleDigitalAssistant Properties Javascript');
...
class OracleDigitalAssistantProperties extends OkitResourceProperties {
    ...
    buildResource() {
        ...
        // Shape Name
        const shape_name = this.createInput('select', 'Shape', `${self.id}_shape_name`, '', (d, i, n) => self.resource.shape_name = n[i].value)
