...
class OCIJsonValidator(object):
    pca_resources      = ['block_storage_volume', 'compartment', 'dhcp_option', 'dynamic_routing_gateway', 'dynamic_routing_gateway_attachment', 'file_system', 'group', 'instance', 'internet_gateway', 'local_peering_gateway', 'mount_target', 'nat_gateway', 'network_security_group', 'object_storage_bucket', 'policy', 'route_table', 'security_list', 'subnet', 'user', 'virtual_cloud_network']
