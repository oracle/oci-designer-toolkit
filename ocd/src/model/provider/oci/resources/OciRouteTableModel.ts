...
export interface OciRouteTableModel extends AutoGenerated.OciRouteTableAutoGeneratedModel {}
...
export namespace OciRouteTableModel {
    export function newResource(type?: string): OciRouteTableModel {
        return {
            ...AutoGenerated.OciRouteTableAutoGeneratedModel.newResource('route_table'),
        }
    }
    
    export function newOciRouteRulesModel(): OciRouteRulesModel {
        return {
            ...AutoGenerated.OciRouteTableAutoGeneratedModel.newOciRouteRulesModel(),
        }
    }
