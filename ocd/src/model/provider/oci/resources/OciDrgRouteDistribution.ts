...
export interface OciDrgRouteDistribution extends OciDrgRouteDistributionAutoGenerated {
}

export namespace OciDrgRouteDistribution {
    export function newResource(type?: string): OciDrgRouteDistribution {
        return {
            ...OciDrgRouteDistributionAutoGenerated.newResource('drg_route_distribution'),
        }
    }
}
