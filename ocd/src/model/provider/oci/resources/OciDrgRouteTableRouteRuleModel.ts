...
export interface OciDrgRouteTableRouteRuleModel extends AutoGenerated.OciDrgRouteTableRouteRuleAutoGeneratedModel {}

export namespace OciDrgRouteTableRouteRuleModel {
    export function newResource(type?: string): OciDrgRouteTableRouteRuleModel {
        return {
            ...AutoGenerated.OciDrgRouteTableRouteRuleAutoGeneratedModel.newResource('drg_route_table_route_rule'),
        }
    }
