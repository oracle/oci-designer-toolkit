...
export interface OciDrgRouteDistributionModel extends AutoGenerated.OciDrgRouteDistributionAutoGeneratedModel {}

export namespace OciDrgRouteDistributionModel {
    export function newResource(type?: string): OciDrgRouteDistributionModel {
        return {
            ...AutoGenerated.OciDrgRouteDistributionAutoGeneratedModel.newResource('drg_route_distribution'),
        }
    }
