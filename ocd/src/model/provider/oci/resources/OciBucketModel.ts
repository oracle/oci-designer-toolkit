...
import { OciBucketAutoGeneratedModel } from "./generated/OciBucketModel"

export interface OciBucketModel extends OciBucketAutoGeneratedModel {
}

export namespace OciBucketModel {
    export function newResource(type?: string): OciBucketModel {
        return {
            ...OciBucketAutoGeneratedModel.newResource('bucket'),
        }
    }
}
