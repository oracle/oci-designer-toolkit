...
export interface OciRemotePeeringConnectionModel extends AutoGenerated.OciRemotePeeringConnectionModel {}

export namespace OciRemotePeeringConnectionModel {
    export function newResource(type?: string): OciRemotePeeringConnectionModel {
        return {
            ...AutoGenerated.OciRemotePeeringConnectionModel.newResource('remote_peering_connection'),
        }
    }
