...
export interface OciServiceGatewayModel extends AutoGenerated.OciServiceGatewayAutoGeneratedModel {}
...
export namespace OciServiceGatewayModel {
    export function newResource(type?: string): OciServiceGatewayModel {
        return {
            ...AutoGenerated.OciServiceGatewayAutoGeneratedModel.newResource('service_gateway'),
        }
    }
    
    export function newOciServicesModel(): OciServicesModel {
        return {
            ...AutoGenerated.OciServiceGatewayAutoGeneratedModel.newOciServicesModel(),
        }
    }
