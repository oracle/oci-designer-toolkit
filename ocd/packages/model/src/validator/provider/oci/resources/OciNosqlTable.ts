...
import * as AutoGenerated from './generated/OciNosqlTable.js'
...
export namespace OciNosqlTable {
    export function validateResource(resource: Model.OciNosqlTable, resources: OciResources): OcdValidationResult[] {
        return [...AutoGenerated.OciNosqlTable.validateResource(resource, resources), ...customValidation(resource, resources)]
    }
    export function isResourceValid(resource: Model.OciNosqlTable, resources: OciResources): boolean {
        return (validateResource(resource, resources).filter((v: OcdValidationResult) => !v.valid).length > 0)
    }
    export function hasErrors(resource: Model.OciNosqlTable, resources: OciResources): boolean {
        return (validateResource(resource, resources).filter((v: OcdValidationResult) => v.type === 'error').length > 0)
    }
    export function hasWarnings(resource: Model.OciNosqlTable, resources: OciResources): boolean {
        return (validateResource(resource, resources).filter((v: OcdValidationResult) => v.type === 'warning').length > 0)
    }
    export function hasInformation(resource: Model.OciNosqlTable, resources: OciResources): boolean {
        return (validateResource(resource, resources).filter((v: OcdValidationResult) => v.type === 'information').length > 0)
    }
    function customValidation(resource: Model.OciNosqlTable, resources: OciResources): OcdValidationResult[] {
