...
import * as AutoGenerated from './generated/OciDrgRouteDistribution.js'
...
export namespace OciDrgRouteDistribution {
    export function validateResource(resource: Model.OciDrgRouteDistribution, resources: OciResources): OcdValidationResult[] {
        return [...AutoGenerated.OciDrgRouteDistribution.validateResource(resource, resources), ...customValidation(resource, resources)]
    }
    export function isResourceValid(resource: Model.OciDrgRouteDistribution, resources: OciResources): boolean {
        return (validateResource(resource, resources).filter((v: OcdValidationResult) => !v.valid).length > 0)
    }
    export function hasErrors(resource: Model.OciDrgRouteDistribution, resources: OciResources): boolean {
        return (validateResource(resource, resources).filter((v: OcdValidationResult) => v.type === 'error').length > 0)
    }
    export function hasWarnings(resource: Model.OciDrgRouteDistribution, resources: OciResources): boolean {
        return (validateResource(resource, resources).filter((v: OcdValidationResult) => v.type === 'warning').length > 0)
    }
    export function hasInformation(resource: Model.OciDrgRouteDistribution, resources: OciResources): boolean {
        return (validateResource(resource, resources).filter((v: OcdValidationResult) => v.type === 'information').length > 0)
    }
    function customValidation(resource: Model.OciDrgRouteDistribution, resources: OciResources): OcdValidationResult[] {
