...
export namespace OciDrgRouteTableRouteRule {
    export function validateResource(resource: Model.OciDrgRouteTableRouteRule, resources: OciResources): OcdValidationResult[] {
        return [...AutoGenerated.OciDrgRouteTableRouteRule.validateResource(resource, resources), ...customValidation(resource, resources)]
    }
    export function isResourceValid(resource: Model.OciDrgRouteTableRouteRule, resources: OciResources): boolean {
        return (validateResource(resource, resources).filter((v: OcdValidationResult) => !v.valid).length > 0)
    }
    export function hasErrors(resource: Model.OciDrgRouteTableRouteRule, resources: OciResources): boolean {
        return (validateResource(resource, resources).filter((v: OcdValidationResult) => v.type === 'error').length > 0)
    }
    export function hasWarnings(resource: Model.OciDrgRouteTableRouteRule, resources: OciResources): boolean {
        return (validateResource(resource, resources).filter((v: OcdValidationResult) => v.type === 'warning').length > 0)
    }
    export function hasInformation(resource: Model.OciDrgRouteTableRouteRule, resources: OciResources): boolean {
        return (validateResource(resource, resources).filter((v: OcdValidationResult) => v.type === 'information').length > 0)
    }
    function customValidation(resource: Model.OciDrgRouteTableRouteRule, resources: OciResources): OcdValidationResult[] {
