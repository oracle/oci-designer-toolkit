...
export namespace OciNetworkSecurityGroup {
    export function validateResource(resource: Model.OciNetworkSecurityGroup, resources: OciResources): OcdValidationResult[] {
        return [...AutoGenerated.OciNetworkSecurityGroup.validateResource(resource, resources), ...customValidation(resource, resources)]
    }
    export function isResourceValid(resource: Model.OciNetworkSecurityGroup, resources: OciResources): boolean {
        return (validateResource(resource, resources).filter((v: OcdValidationResult) => !v.valid).length > 0)
    }
    export function hasErrors(resource: Model.OciNetworkSecurityGroup, resources: OciResources): boolean {
        return (validateResource(resource, resources).filter((v: OcdValidationResult) => v.type === 'error').length > 0)
    }
    export function hasWarnings(resource: Model.OciNetworkSecurityGroup, resources: OciResources): boolean {
        return (validateResource(resource, resources).filter((v: OcdValidationResult) => v.type === 'warning').length > 0)
    }
    export function hasInformation(resource: Model.OciNetworkSecurityGroup, resources: OciResources): boolean {
        return (validateResource(resource, resources).filter((v: OcdValidationResult) => v.type === 'information').length > 0)
    }
    function customValidation(resource: Model.OciNetworkSecurityGroup, resources: OciResources): OcdValidationResult[] {
