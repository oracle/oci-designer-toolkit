...
export namespace OciBucket {
    ...
    export interface OciRetentionRules extends AutoGenerated.OciBucket.OciRetentionRules {}

    export interface OciDuration extends AutoGenerated.OciBucket.OciDuration {}
