...
export namespace OciInstance {
    ...
    export interface OciMetadata extends AutoGenerated.OciInstance.OciMetadata {}
    ...
    export function getConnectionIds(resource: OciInstance, allResources: OcdResources): string[] {
        ...
        let associationIds = allResources.volume_attachment ? allResources.volume_attachment.filter((v) => v.instanceId === resource.id).map((v) => v.volumeId) : []
    ...
    export function newOciMetadata(): OciMetadata {
        return {
            ...AutoGenerated.OciInstance.newOciMetadata(),
        }
    }
