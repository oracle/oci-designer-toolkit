...
export interface OciClusterPodNetworkOptions extends AutoGenerated.OciClusterPodNetworkOptions {}
...
export interface OciPersistentVolumeConfig extends AutoGenerated.OciPersistentVolumeConfig {}

export interface OciServiceLbConfig extends AutoGenerated.OciServiceLbConfig {}

export namespace OciOkeCluster {
    
    export interface OciClusterPodNetworkOptions extends AutoGenerated.OciOkeCluster.OciClusterPodNetworkOptions {}

    export interface OciEndpointConfig extends AutoGenerated.OciOkeCluster.OciEndpointConfig {}

    export interface OciImagePolicyConfig extends AutoGenerated.OciOkeCluster.OciImagePolicyConfig {}

    export interface OciKeyDetails extends AutoGenerated.OciOkeCluster.OciKeyDetails {}

    export interface OciOptions extends AutoGenerated.OciOkeCluster.OciOptions {}

    export interface OciAddOns extends AutoGenerated.OciOkeCluster.OciAddOns {}

    export interface OciAdmissionControllerOptions extends AutoGenerated.OciOkeCluster.OciAdmissionControllerOptions {}

    export interface OciKubernetesNetworkConfig extends AutoGenerated.OciOkeCluster.OciKubernetesNetworkConfig {}

    export interface OciPersistentVolumeConfig extends AutoGenerated.OciOkeCluster.OciPersistentVolumeConfig {}

    export interface OciServiceLbConfig extends AutoGenerated.OciOkeCluster.OciServiceLbConfig {}
    ...
    export function allowedParentTypes(): string[] {
        console.debug('OciOkeCluster: Allowed Parent Types')
        return []
    }
    ...
    export function newOciClusterPodNetworkOptions(): OciClusterPodNetworkOptions {
        return {
            ...AutoGenerated.OciOkeCluster.newOciClusterPodNetworkOptions(),
        }
    }
    ...
    export function newOciPersistentVolumeConfig(): OciPersistentVolumeConfig {
        return {
            ...AutoGenerated.OciOkeCluster.newOciPersistentVolumeConfig(),
        }
    }

    export function newOciServiceLbConfig(): OciServiceLbConfig {
        return {
            ...AutoGenerated.OciOkeCluster.newOciServiceLbConfig(),
        }
    }
