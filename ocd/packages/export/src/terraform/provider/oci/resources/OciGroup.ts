...
export class OciGroup extends AutoGenerated.OciGroup {
    constructor(resource: Model.OciGroup, idTFResourceMap: Record<string, string> = {}, isHomeRegion: boolean = true) {
