...
${resources.sort().map((r) => `export { ${this.proxyNamespace(r)} } from './${this.resourcesDirectory()}/proxies/${this.resourceName(r)}'`).join('\n')}
    ...
    attributeToReactElement = (resource, attribute) => {
        ...
        let elementJSX = ''
        if (attribute.type === 'string' && attribute.lookup)                  elementJSX =  `<${this.reactSimpleName(attribute.id)} ocdDocument={ocdDocument} setOcdDocument={(ocdDocument:OcdDocument) => setOcdDocument(ocdDocument)} resource={resource} configs={configs} rootResource={rootResource} key={\`\${rootResource.id}-${attribute.id}\`} />`
        else if (attribute.type === 'string')                                 elementJSX =  `<${this.reactSimpleName(attribute.id)} ocdDocument={ocdDocument} setOcdDocument={(ocdDocument:OcdDocument) => setOcdDocument(ocdDocument)} resource={resource} configs={configs} rootResource={rootResource} key={\`\${rootResource.id}-${attribute.id}\`} />`
        else if (attribute.type === 'bool')                                   elementJSX =  `<${this.reactSimpleName(attribute.id)} ocdDocument={ocdDocument} setOcdDocument={(ocdDocument:OcdDocument) => setOcdDocument(ocdDocument)} resource={resource} configs={configs} rootResource={rootResource} key={\`\${rootResource.id}-${attribute.id}\`} />`
        else if (attribute.type === 'number')                                 elementJSX =  `<${this.reactSimpleName(attribute.id)} ocdDocument={ocdDocument} setOcdDocument={(ocdDocument:OcdDocument) => setOcdDocument(ocdDocument)} resource={resource} configs={configs} rootResource={rootResource} key={\`\${rootResource.id}-${attribute.id}\`} />`
        else if (attribute.type === 'object')                                 elementJSX =  `{isPropertyDisplayConditionTrue(${attribute.conditional}, ${JSON.stringify(attribute.condition)}, resource, rootResource) && <${this.reactObjectName(attribute.id)} ocdDocument={ocdDocument} setOcdDocument={(ocdDocument:OcdDocument) => setOcdDocument(ocdDocument)} resource={resource['${attribute.key}']} configs={configs} rootResource={rootResource} additionalElements={additionalElements} key={\`\${rootResource.id}-${attribute.id}\`} />}`
        ...
        else if (attribute.type === 'list' && attribute.subtype === 'string') elementJSX =  `<${this.reactSimpleName(attribute.id)} ocdDocument={ocdDocument} setOcdDocument={(ocdDocument:OcdDocument) => setOcdDocument(ocdDocument)} resource={resource} configs={configs} rootResource={rootResource} key={\`\${rootResource.id}-${attribute.id}\`} />`
        ...
        else if (attribute.type === 'list')                                   elementJSX =  `<OcdListProperty       ocdDocument={ocdDocument} setOcdDocument={(ocdDocument:OcdDocument) => setOcdDocument(ocdDocument)} resource={resource} config={${configFind}} attribute={${JSON.stringify(attribute)}} rootResource={rootResource} key={\`\${rootResource.id}-${attribute.id}\`} />`
        ...
        else if (attribute.type === 'set' && attribute.lookup)                elementJSX =  `<OcdSetLookupProperty  ocdDocument={ocdDocument} setOcdDocument={(ocdDocument:OcdDocument) => setOcdDocument(ocdDocument)} resource={resource} config={${configFind}} attribute={${JSON.stringify(attribute)}} rootResource={rootResource} key={\`\${rootResource.id}-${attribute.id}\`} />`
        else if (attribute.type === 'map')                                    elementJSX =  `<OcdMapProperty        ocdDocument={ocdDocument} setOcdDocument={(ocdDocument:OcdDocument) => setOcdDocument(ocdDocument)} resource={resource} config={${configFind}} attribute={${JSON.stringify(attribute)}} rootResource={rootResource} key={\`\${rootResource.id}-${attribute.id}\`} />`
        // return elementJSX
        return `${elementJSX}\n                    ${additionalElement}`
    }
