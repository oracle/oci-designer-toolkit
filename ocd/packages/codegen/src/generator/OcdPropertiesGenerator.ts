...
import { ${this.prefix}CommonConfigs } from "../../${this.prefix}CommonConfigs"
...
${resources.sort(this.simpleSort).map((r) => `export { ${this.namespaceName(r)} } from './${this.resourcesDirectory()}/${this.resourceName(r)}'`).join('\n')}
