...
export const AzureKubernetesCluster = ({ ocdDocument, azureResources, selected }: AzureTabularResourceProps): JSX.Element => {
    ...
    return (
        <OcdTabularContents 
            ...
            key={'AzureKubernetesClusterTabularContents'}
        />
    )
}
