...
export const OciFilesystemSnapshotPolicy = ({ ocdDocument, ociResources, selected }: OciTabularResourceProps): JSX.Element => {
    ...
    return (
        <OcdTabularContents 
            ...
            key={'OciFilesystemSnapshotPolicyTabularContents'}
        />
    )
}
