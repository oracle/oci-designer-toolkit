...
export const OciNetworkLoadBalancerBackendSet = ({ ocdDocument, ociResources, selected }: OciTabularResourceProps): JSX.Element => {
    ...
    return (
        <OcdTabularContents 
            ...
            key={'OciNetworkLoadBalancerBackendSetTabularContents'}
        />
    )
}
