...
export const OciNetworkFirewallPolicy = ({ ocdDocument, ociResources, selected }: OciTabularResourceProps): JSX.Element => {
    ...
    return (
        <OcdTabularContents 
            ...
            key={'OciNetworkFirewallPolicyTabularContents'}
        />
    )
}
