...
export const OciVisualBuilderInstance = ({ ocdDocument, ociResources, selected }: OciTabularResourceProps): JSX.Element => {
    ...
    return (
        <OcdTabularContents 
            ...
            key={'OciVisualBuilderInstanceTabularContents'}
        />
    )
}
