...
export const OciStackMonitoringConfig = ({ ocdDocument, ociResources, selected }: OciTabularResourceProps): JSX.Element => {
    ...
    return (
        <OcdTabularContents 
            ...
            key={'OciStackMonitoringConfigTabularContents'}
        />
    )
}
