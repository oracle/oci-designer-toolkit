...
export const OciDatascienceModelDeployment = ({ ocdDocument, ociResources, selected }: OciTabularResourceProps): JSX.Element => {
    ...
    return (
        <OcdTabularContents 
            ...
            key={'OciDatascienceModelDeploymentTabularContents'}
        />
    )
}
