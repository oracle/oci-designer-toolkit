...
export const OciCloudMigrationsMigration = ({ ocdDocument, ociResources, selected }: OciTabularResourceProps): JSX.Element => {
    ...
    return (
        <OcdTabularContents
            ...
            key={'OciCloudMigrationsMigrationTabularContents'}
        />
    )
}
