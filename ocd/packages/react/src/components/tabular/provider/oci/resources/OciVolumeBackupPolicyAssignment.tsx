...
export const OciVolumeBackupPolicyAssignment = ({ ocdDocument, ociResources, selected }: OciTabularResourceProps): JSX.Element => {
    ...
    return (
        <OcdTabularContents 
            ...
            key={'OciVolumeBackupPolicyAssignmentTabularContents'}
        />
    )
}
