...
export const OciLicenseManagerProductLicense = ({ ocdDocument, ociResources, selected }: OciTabularResourceProps): JSX.Element => {
    ...
    return (
        <OcdTabularContents 
            ...
            key={'OciLicenseManagerProductLicenseTabularContents'}
        />
    )
}
