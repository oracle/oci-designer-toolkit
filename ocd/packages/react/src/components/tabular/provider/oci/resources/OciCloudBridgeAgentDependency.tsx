...
export const OciCloudBridgeAgentDependency = ({ ocdDocument, ociResources, selected }: OciTabularResourceProps): JSX.Element => {
    ...
    return (
        <OcdTabularContents
            ...
            key={'OciCloudBridgeAgentDependencyTabularContents'}
        />
    )
}
