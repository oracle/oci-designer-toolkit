...
export const OciExternalDbSystemConnector = ({ ocdDocument, ociResources, selected }: OciTabularResourceProps): JSX.Element => {
    ...
    return (
        <OcdTabularContents 
            ...
            key={'OciExternalDbSystemConnectorTabularContents'}
        />
    )
}
