...
export const OciCloudMigrationsMigrationAsset = ({ ocdDocument, ociResources, selected }: OciTabularResourceProps): JSX.Element => {
    ...
    return (
        <OcdTabularContents
            ...
            key={'OciCloudMigrationsMigrationAssetTabularContents'}
        />
    )
}
