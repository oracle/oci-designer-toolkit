...
export const OciCloudGuardConfiguration = ({ ocdDocument, ociResources, selected }: OciTabularResourceProps): JSX.Element => {
    ...
    return (
        <OcdTabularContents 
            ...
            key={'OciCloudGuardConfigurationTabularContents'}
        />
    )
}
