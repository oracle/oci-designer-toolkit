...
export const OciCloudMigrationsMigrationPlan = ({ ocdDocument, ociResources, selected }: OciTabularResourceProps): JSX.Element => {
    ...
    return (
        <OcdTabularContents
            ...
            key={'OciCloudMigrationsMigrationPlanTabularContents'}
        />
    )
}
