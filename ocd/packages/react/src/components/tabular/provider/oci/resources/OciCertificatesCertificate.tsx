...
export const OciCertificatesCertificate = ({ ocdDocument, ociResources, selected }: OciTabularResourceProps): JSX.Element => {
    ...
    return (
        <OcdTabularContents 
            ...
            key={'OciCertificatesCertificateTabularContents'}
        />
    )
}
