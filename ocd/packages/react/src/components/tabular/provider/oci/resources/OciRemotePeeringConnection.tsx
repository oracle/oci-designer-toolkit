...
export const OciRemotePeeringConnection = ({ ocdDocument, ociResources, selected }: OciTabularResourceProps): JSX.Element => {
    ...
    return (
        <OcdTabularContents 
            ...
            key={'OciRemotePeeringConnectionTabularContents'}
        />
    )
}
