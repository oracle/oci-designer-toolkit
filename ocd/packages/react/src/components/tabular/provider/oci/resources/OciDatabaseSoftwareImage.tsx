...
export const OciDatabaseSoftwareImage = ({ ocdDocument, ociResources, selected }: OciTabularResourceProps): JSX.Element => {
    ...
    return (
        <OcdTabularContents 
            ...
            key={'OciDatabaseSoftwareImageTabularContents'}
        />
    )
}
