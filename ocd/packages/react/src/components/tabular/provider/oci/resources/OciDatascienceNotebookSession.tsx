...
export const OciDatascienceNotebookSession = ({ ocdDocument, ociResources, selected }: OciTabularResourceProps): JSX.Element => {
    ...
    return (
        <OcdTabularContents 
            ...
            key={'OciDatascienceNotebookSessionTabularContents'}
        />
    )
}
