...
export const OciAutonomousContainerDatabase = ({ ocdDocument, ociResources, selected }: OciTabularResourceProps): JSX.Element => {
    ...
    return (
        <OcdTabularContents 
            ...
            key={'OciAutonomousContainerDatabaseTabularContents'}
        />
    )
}
