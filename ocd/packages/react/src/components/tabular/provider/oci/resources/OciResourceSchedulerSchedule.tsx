...
export const OciResourceSchedulerSchedule = ({ ocdDocument, ociResources, selected }: OciTabularResourceProps): JSX.Element => {
    ...
    return (
        <OcdTabularContents 
            ...
            key={'OciResourceSchedulerScheduleTabularContents'}
        />
    )
}
