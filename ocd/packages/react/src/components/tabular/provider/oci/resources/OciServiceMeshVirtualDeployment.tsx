...
export const OciServiceMeshVirtualDeployment = ({ ocdDocument, ociResources, selected }: OciTabularResourceProps): JSX.Element => {
    ...
    return (
        <OcdTabularContents 
            ...
            key={'OciServiceMeshVirtualDeploymentTabularContents'}
        />
    )
}
