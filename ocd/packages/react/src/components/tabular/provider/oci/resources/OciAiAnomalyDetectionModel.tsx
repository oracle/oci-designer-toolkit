...
export const OciAiAnomalyDetectionModel = ({ ocdDocument, ociResources, selected }: OciTabularResourceProps): JSX.Element => {
    ...
    return (
        <OcdTabularContents 
            ...
            key={'OciAiAnomalyDetectionModelTabularContents'}
        />
    )
}
