...
export const OciLicenseManagerConfiguration = ({ ocdDocument, ociResources, selected }: OciTabularResourceProps): JSX.Element => {
    ...
    return (
        <OcdTabularContents 
            ...
            key={'OciLicenseManagerConfigurationTabularContents'}
        />
    )
}
