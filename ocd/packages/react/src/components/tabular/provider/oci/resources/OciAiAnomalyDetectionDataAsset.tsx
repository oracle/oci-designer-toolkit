...
export const OciAiAnomalyDetectionDataAsset = ({ ocdDocument, ociResources, selected }: OciTabularResourceProps): JSX.Element => {
    ...
    return (
        <OcdTabularContents
            ...
            key={'OciAiAnomalyDetectionDataAssetTabularContents'}
        />
    )
}
