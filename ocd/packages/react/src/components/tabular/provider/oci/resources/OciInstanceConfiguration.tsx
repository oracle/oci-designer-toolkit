...
export const OciInstanceConfiguration = ({ ocdDocument, ociResources, selected }: OciTabularResourceProps): JSX.Element => {
    ...
    return (
        <OcdTabularContents 
            ...
            key={'OciInstanceConfigurationTabularContents'}
        />
    )
}
