...
export const OciDnsSteeringPolicyAttachment = ({ ocdDocument, ociResources, selected }: OciTabularResourceProps): JSX.Element => {
    ...
    return (
        <OcdTabularContents 
            ...
            key={'OciDnsSteeringPolicyAttachmentTabularContents'}
        />
    )
}
