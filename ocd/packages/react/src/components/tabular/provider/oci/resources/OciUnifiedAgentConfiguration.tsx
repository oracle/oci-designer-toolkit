...
export const OciUnifiedAgentConfiguration = ({ ocdDocument, ociResources, selected }: OciTabularResourceProps): JSX.Element => {
    ...
    return (
        <OcdTabularContents 
            ...
            key={'OciUnifiedAgentConfigurationTabularContents'}
        />
    )
}
