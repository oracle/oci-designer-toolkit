...
export const OciInstanceConsoleConnection = ({ ocdDocument, ociResources, selected }: OciTabularResourceProps): JSX.Element => {
    ...
    return (
        <OcdTabularContents 
            ...
            key={'OciInstanceConsoleConnectionTabularContents'}
        />
    )
}
