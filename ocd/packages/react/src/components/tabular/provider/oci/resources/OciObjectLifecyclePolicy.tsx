...
export const OciObjectLifecyclePolicy = ({ ocdDocument, ociResources, selected }: OciTabularResourceProps): JSX.Element => {
    ...
    return (
        <OcdTabularContents 
            ...
            key={'OciObjectLifecyclePolicyTabularContents'}
        />
    )
}
