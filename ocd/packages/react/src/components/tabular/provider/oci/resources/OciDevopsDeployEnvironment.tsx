...
export const OciDevopsDeployEnvironment = ({ ocdDocument, ociResources, selected }: OciTabularResourceProps): JSX.Element => {
    ...
    return (
        <OcdTabularContents 
            ...
            key={'OciDevopsDeployEnvironmentTabularContents'}
        />
    )
}
