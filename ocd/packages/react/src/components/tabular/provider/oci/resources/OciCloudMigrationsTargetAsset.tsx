...
export const OciCloudMigrationsTargetAsset = ({ ocdDocument, ociResources, selected }: OciTabularResourceProps): JSX.Element => {
    ...
    return (
        <OcdTabularContents
            ...
            key={'OciCloudMigrationsTargetAssetTabularContents'}
        />
    )
}
