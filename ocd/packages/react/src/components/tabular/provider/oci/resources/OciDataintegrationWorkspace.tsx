...
export const OciDataintegrationWorkspace = ({ ocdDocument, ociResources, selected }: OciTabularResourceProps): JSX.Element => {
    ...
    return (
        <OcdTabularContents 
            ...
            key={'OciDataintegrationWorkspaceTabularContents'}
        />
    )
}
