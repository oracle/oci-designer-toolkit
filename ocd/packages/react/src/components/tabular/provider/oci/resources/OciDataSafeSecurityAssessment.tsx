...
export const OciDataSafeSecurityAssessment = ({ ocdDocument, ociResources, selected }: OciTabularResourceProps): JSX.Element => {
    ...
    return (
        <OcdTabularContents 
            ...
            key={'OciDataSafeSecurityAssessmentTabularContents'}
        />
    )
}
