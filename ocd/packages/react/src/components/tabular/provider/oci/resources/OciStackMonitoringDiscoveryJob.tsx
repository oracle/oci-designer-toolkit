...
export const OciStackMonitoringDiscoveryJob = ({ ocdDocument, ociResources, selected }: OciTabularResourceProps): JSX.Element => {
    ...
    return (
        <OcdTabularContents
            ...
            key={'OciStackMonitoringDiscoveryJobTabularContents'}
        />
    )
}
