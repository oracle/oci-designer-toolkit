...
export const OciServiceMeshVirtualService = ({ ocdDocument, ociResources, selected }: OciTabularResourceProps): JSX.Element => {
    ...
    return (
        <OcdTabularContents 
            ...
            key={'OciServiceMeshVirtualServiceTabularContents'}
        />
    )
}
