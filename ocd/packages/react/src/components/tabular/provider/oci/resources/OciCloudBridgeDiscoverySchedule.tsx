...
export const OciCloudBridgeDiscoverySchedule = ({ ocdDocument, ociResources, selected }: OciTabularResourceProps): JSX.Element => {
    ...
    return (
        <OcdTabularContents
            ...
            key={'OciCloudBridgeDiscoveryScheduleTabularContents'}
        />
    )
}
