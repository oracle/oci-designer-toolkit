...
export const OciManagementAgentInstallKey = ({ ocdDocument, ociResources, selected }: OciTabularResourceProps): JSX.Element => {
    ...
    return (
        <OcdTabularContents 
            ...
            key={'OciManagementAgentInstallKeyTabularContents'}
        />
    )
}
