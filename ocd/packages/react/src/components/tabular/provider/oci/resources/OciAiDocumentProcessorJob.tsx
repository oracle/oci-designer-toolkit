...
export const OciAiDocumentProcessorJob = ({ ocdDocument, ociResources, selected }: OciTabularResourceProps): JSX.Element => {
    ...
    return (
        <OcdTabularContents 
            ...
            key={'OciAiDocumentProcessorJobTabularContents'}
        />
    )
}
