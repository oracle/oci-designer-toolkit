...
export const OciCertificatesCertificateAuthority = ({ ocdDocument, ociResources, selected }: OciTabularResourceProps): JSX.Element => {
    ...
    return (
        <OcdTabularContents 
            ...
            key={'OciCertificatesCertificateAuthorityTabularContents'}
        />
    )
}
