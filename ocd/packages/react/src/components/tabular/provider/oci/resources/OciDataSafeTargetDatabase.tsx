...
export const OciDataSafeTargetDatabase = ({ ocdDocument, ociResources, selected }: OciTabularResourceProps): JSX.Element => {
    ...
    return (
        <OcdTabularContents 
            ...
            key={'OciDataSafeTargetDatabaseTabularContents'}
        />
    )
}
