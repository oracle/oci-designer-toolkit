...
export const OciLogAnalyticsObjectCollectionRule = ({ ocdDocument, ociResources, selected }: OciTabularResourceProps): JSX.Element => {
    ...
    return (
        <OcdTabularContents 
            ...
            key={'OciLogAnalyticsObjectCollectionRuleTabularContents'}
        />
    )
}
