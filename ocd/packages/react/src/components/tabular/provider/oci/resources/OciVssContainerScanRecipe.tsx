...
export const OciVssContainerScanRecipe = ({ ocdDocument, ociResources, selected }: OciTabularResourceProps): JSX.Element => {
    ...
    return (
        <OcdTabularContents 
            ...
            key={'OciVssContainerScanRecipeTabularContents'}
        />
    )
}
