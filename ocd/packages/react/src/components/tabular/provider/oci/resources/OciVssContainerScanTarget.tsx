...
export const OciVssContainerScanTarget = ({ ocdDocument, ociResources, selected }: OciTabularResourceProps): JSX.Element => {
    ...
    return (
        <OcdTabularContents 
            ...
            key={'OciVssContainerScanTargetTabularContents'}
        />
    )
}
