...
export const OciHealthChecksHttpMonitor = ({ ocdDocument, ociResources, selected }: OciTabularResourceProps): JSX.Element => {
    ...
    return (
        <OcdTabularContents 
            ...
            key={'OciHealthChecksHttpMonitorTabularContents'}
        />
    )
}
