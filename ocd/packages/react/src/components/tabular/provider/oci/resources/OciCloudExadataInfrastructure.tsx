...
export const OciCloudExadataInfrastructure = ({ ocdDocument, ociResources, selected }: OciTabularResourceProps): JSX.Element => {
    ...
    return (
        <OcdTabularContents 
            ...
            key={'OciCloudExadataInfrastructureTabularContents'}
        />
    )
}
