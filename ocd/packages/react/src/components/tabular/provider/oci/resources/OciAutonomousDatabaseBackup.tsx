...
export const OciAutonomousDatabaseBackup = ({ ocdDocument, ociResources, selected }: OciTabularResourceProps): JSX.Element => {
    ...
    return (
        <OcdTabularContents 
            ...
            key={'OciAutonomousDatabaseBackupTabularContents'}
        />
    )
}
