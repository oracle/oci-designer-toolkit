...
export const OciApigatewayCertificate = ({ ocdDocument, ociResources, selected }: OciTabularResourceProps): JSX.Element => {
    ...
    return (
        <OcdTabularContents 
            ...
            key={'OciApigatewayCertificateTabularContents'}
        />
    )
}
