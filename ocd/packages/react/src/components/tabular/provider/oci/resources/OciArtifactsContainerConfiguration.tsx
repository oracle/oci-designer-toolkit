...
export const OciArtifactsContainerConfiguration = ({ ocdDocument, ociResources, selected }: OciTabularResourceProps): JSX.Element => {
    ...
    return (
        <OcdTabularContents 
            ...
            key={'OciArtifactsContainerConfigurationTabularContents'}
        />
    )
}
