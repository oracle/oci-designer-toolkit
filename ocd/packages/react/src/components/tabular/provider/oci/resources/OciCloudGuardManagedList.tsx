...
export const OciCloudGuardManagedList = ({ ocdDocument, ociResources, selected }: OciTabularResourceProps): JSX.Element => {
    ...
    return (
        <OcdTabularContents 
            ...
            key={'OciCloudGuardManagedListTabularContents'}
        />
    )
}
