...
export const OciDatabaseMigrationConnection = ({ ocdDocument, ociResources, selected }: OciTabularResourceProps): JSX.Element => {
    ...
    return (
        <OcdTabularContents 
            ...
            key={'OciDatabaseMigrationConnectionTabularContents'}
        />
    )
}
