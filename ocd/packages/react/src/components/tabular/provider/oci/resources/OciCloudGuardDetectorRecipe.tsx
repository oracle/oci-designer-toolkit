...
export const OciCloudGuardDetectorRecipe = ({ ocdDocument, ociResources, selected }: OciTabularResourceProps): JSX.Element => {
    ...
    return (
        <OcdTabularContents 
            ...
            key={'OciCloudGuardDetectorRecipeTabularContents'}
        />
    )
}
