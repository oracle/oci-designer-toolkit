...
export const OciDataSafeUserAssessment = ({ ocdDocument, ociResources, selected }: OciTabularResourceProps): JSX.Element => {
    ...
    return (
        <OcdTabularContents 
            ...
            key={'OciDataSafeUserAssessmentTabularContents'}
        />
    )
}
