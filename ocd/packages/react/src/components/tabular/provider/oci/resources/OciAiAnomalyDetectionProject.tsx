...
export const OciAiAnomalyDetectionProject = ({ ocdDocument, ociResources, selected }: OciTabularResourceProps): JSX.Element => {
    ...
    return (
        <OcdTabularContents 
            ...
            key={'OciAiAnomalyDetectionProjectTabularContents'}
        />
    )
}
