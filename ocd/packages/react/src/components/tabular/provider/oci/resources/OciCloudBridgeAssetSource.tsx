...
export const OciCloudBridgeAssetSource = ({ ocdDocument, ociResources, selected }: OciTabularResourceProps): JSX.Element => {
    ...
    return (
        <OcdTabularContents
            ...
            key={'OciCloudBridgeAssetSourceTabularContents'}
        />
    )
}
