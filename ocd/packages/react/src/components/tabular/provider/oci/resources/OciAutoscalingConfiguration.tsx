...
export const OciAutoscalingConfiguration = ({ ocdDocument, ociResources, selected }: OciTabularResourceProps): JSX.Element => {
    ...
    return (
        <OcdTabularContents 
            ...
            key={'OciAutoscalingConfigurationTabularContents'}
        />
    )
}
