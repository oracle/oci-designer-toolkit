...
export const OciHealthChecksHttpProbe = ({ ocdDocument, ociResources, selected }: OciTabularResourceProps): JSX.Element => {
    ...
    return (
        <OcdTabularContents 
            ...
            key={'OciHealthChecksHttpProbeTabularContents'}
        />
    )
}
