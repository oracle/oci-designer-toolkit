...
export const OciCloudGuardResponderRecipe = ({ ocdDocument, ociResources, selected }: OciTabularResourceProps): JSX.Element => {
    ...
    return (
        <OcdTabularContents 
            ...
            key={'OciCloudGuardResponderRecipeTabularContents'}
        />
    )
}
