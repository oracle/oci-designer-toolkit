...
export namespace OciLimitsQuotaProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciLimitsQuota, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciLimitsQuota>(resource, pH)
