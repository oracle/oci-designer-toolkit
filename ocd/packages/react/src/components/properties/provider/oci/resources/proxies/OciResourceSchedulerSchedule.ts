...
export namespace OciResourceSchedulerScheduleProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciResourceSchedulerSchedule, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciResourceSchedulerSchedule>(resource, pH)
