...
export namespace OciVolumeBackupProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciVolumeBackup, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciVolumeBackup>(resource, pH)
