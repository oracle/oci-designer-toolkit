...
export namespace OciPreauthenticatedRequestProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciPreauthenticatedRequest, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciPreauthenticatedRequest>(resource, pH)
