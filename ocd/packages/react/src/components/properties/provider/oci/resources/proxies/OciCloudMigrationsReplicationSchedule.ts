...
export namespace OciCloudMigrationsReplicationScheduleProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciCloudMigrationsReplicationSchedule, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciCloudMigrationsReplicationSchedule>(resource, pH)
