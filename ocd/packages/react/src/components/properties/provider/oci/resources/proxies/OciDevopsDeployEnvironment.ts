...
export namespace OciDevopsDeployEnvironmentProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciDevopsDeployEnvironment, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciDevopsDeployEnvironment>(resource, pH)
