...
export namespace OciVisualBuilderInstanceProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciVisualBuilderInstance, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciVisualBuilderInstance>(resource, pH)
