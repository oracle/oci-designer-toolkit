...
export namespace OciApigatewayCertificateProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciApigatewayCertificate, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciApigatewayCertificate>(resource, pH)
