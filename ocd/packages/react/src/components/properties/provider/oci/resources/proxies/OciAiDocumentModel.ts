...
export namespace OciAiDocumentModelProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciAiDocumentModel, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciAiDocumentModel>(resource, pH)
