...
export namespace OciIntegrationInstanceProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciIntegrationInstance, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciIntegrationInstance>(resource, pH)
