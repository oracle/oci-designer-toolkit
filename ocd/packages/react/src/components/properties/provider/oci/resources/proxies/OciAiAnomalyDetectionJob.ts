...
export namespace OciAiAnomalyDetectionJobProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciAiAnomalyDetectionJob, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciAiAnomalyDetectionJob>(resource, pH)
