...
export namespace OciApmSyntheticsMonitorProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciApmSyntheticsMonitor, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciApmSyntheticsMonitor>(resource, pH)
