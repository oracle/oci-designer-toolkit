...
export namespace OciPsqlDbSystemProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciPsqlDbSystem, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciPsqlDbSystem>(resource, pH)
