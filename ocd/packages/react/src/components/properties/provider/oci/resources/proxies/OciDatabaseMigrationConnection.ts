...
export namespace OciDatabaseMigrationConnectionProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciDatabaseMigrationConnection, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciDatabaseMigrationConnection>(resource, pH)
