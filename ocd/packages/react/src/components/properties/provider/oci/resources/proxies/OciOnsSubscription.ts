...
export namespace OciOnsSubscriptionProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciOnsSubscription, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciOnsSubscription>(resource, pH)
