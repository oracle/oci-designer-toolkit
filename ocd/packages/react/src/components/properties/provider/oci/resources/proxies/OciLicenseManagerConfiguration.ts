...
export namespace OciLicenseManagerConfigurationProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciLicenseManagerConfiguration, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciLicenseManagerConfiguration>(resource, pH)
