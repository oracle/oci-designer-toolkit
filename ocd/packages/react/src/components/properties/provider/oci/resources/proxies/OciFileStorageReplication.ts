...
export namespace OciFileStorageReplicationProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciFileStorageReplication, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciFileStorageReplication>(resource, pH)
