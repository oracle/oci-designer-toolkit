...
export namespace OciCloudBridgeEnvironmentProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciCloudBridgeEnvironment, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciCloudBridgeEnvironment>(resource, pH)
