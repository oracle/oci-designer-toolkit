...
export namespace OciResourcemanagerPrivateEndpointProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciResourcemanagerPrivateEndpoint, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciResourcemanagerPrivateEndpoint>(resource, pH)
