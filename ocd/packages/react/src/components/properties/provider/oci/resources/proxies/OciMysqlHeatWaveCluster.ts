...
export namespace OciMysqlHeatWaveClusterProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciMysqlHeatWaveCluster, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciMysqlHeatWaveCluster>(resource, pH)
