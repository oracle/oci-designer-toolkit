...
export namespace OciCertificatesCertificateProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciCertificatesCertificate, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciCertificatesCertificate>(resource, pH)
