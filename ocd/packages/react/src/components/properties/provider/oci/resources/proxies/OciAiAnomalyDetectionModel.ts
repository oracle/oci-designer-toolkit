...
export namespace OciAiAnomalyDetectionModelProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciAiAnomalyDetectionModel, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciAiAnomalyDetectionModel>(resource, pH)
