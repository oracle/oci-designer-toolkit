...
export namespace OciDataintegrationWorkspaceProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciDataintegrationWorkspace, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciDataintegrationWorkspace>(resource, pH)
