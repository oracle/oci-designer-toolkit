...
export namespace OciOpsiExadataInsightProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciOpsiExadataInsight, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciOpsiExadataInsight>(resource, pH)
