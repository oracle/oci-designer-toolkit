...
export namespace OciApigatewayUsagePlanProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciApigatewayUsagePlan, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciApigatewayUsagePlan>(resource, pH)
