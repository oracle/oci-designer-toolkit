...
export namespace OciLoadBalancerHostnameProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciLoadBalancerHostname, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciLoadBalancerHostname>(resource, pH)
