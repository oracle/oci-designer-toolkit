...
export namespace OciServiceCatalogProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciServiceCatalog, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciServiceCatalog>(resource, pH)
