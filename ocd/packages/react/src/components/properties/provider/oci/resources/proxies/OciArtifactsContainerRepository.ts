...
export namespace OciArtifactsContainerRepositoryProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciArtifactsContainerRepository, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciArtifactsContainerRepository>(resource, pH)
