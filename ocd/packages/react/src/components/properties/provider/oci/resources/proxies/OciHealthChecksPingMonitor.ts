...
export namespace OciHealthChecksPingMonitorProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciHealthChecksPingMonitor, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciHealthChecksPingMonitor>(resource, pH)
