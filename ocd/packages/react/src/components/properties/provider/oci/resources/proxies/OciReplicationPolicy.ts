...
export namespace OciReplicationPolicyProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciReplicationPolicy, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciReplicationPolicy>(resource, pH)
