...
export namespace OciDataSafeSecurityAssessmentProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciDataSafeSecurityAssessment, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciDataSafeSecurityAssessment>(resource, pH)
