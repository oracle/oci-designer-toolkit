...
export namespace OciFilesystemSnapshotPolicyProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciFilesystemSnapshotPolicy, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciFilesystemSnapshotPolicy>(resource, pH)
