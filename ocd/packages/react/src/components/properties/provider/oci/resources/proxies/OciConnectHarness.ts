...
export namespace OciConnectHarnessProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciConnectHarness, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciConnectHarness>(resource, pH)
