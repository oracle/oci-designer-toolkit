...
export namespace OciWafNetworkAddressListProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciWafNetworkAddressList, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciWafNetworkAddressList>(resource, pH)
