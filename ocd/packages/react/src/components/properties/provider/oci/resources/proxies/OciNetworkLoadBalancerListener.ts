...
export namespace OciNetworkLoadBalancerListenerProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciNetworkLoadBalancerListener, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciNetworkLoadBalancerListener>(resource, pH)
