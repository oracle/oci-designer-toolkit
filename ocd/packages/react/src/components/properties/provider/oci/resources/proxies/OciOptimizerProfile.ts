...
export namespace OciOptimizerProfileProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciOptimizerProfile, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciOptimizerProfile>(resource, pH)
