...
export namespace OciVssContainerScanTargetProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciVssContainerScanTarget, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciVssContainerScanTarget>(resource, pH)
