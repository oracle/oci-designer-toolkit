...
export namespace OciGoldenGateDeploymentProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciGoldenGateDeployment, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciGoldenGateDeployment>(resource, pH)
