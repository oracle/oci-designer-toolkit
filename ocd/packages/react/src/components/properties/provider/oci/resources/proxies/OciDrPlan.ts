...
export namespace OciDrPlanProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciDrPlan, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciDrPlan>(resource, pH)
