...
export namespace OciMysqlReplicaProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciMysqlReplica, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciMysqlReplica>(resource, pH)
