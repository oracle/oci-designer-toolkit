...
export namespace OciDnsSteeringPolicyAttachmentProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciDnsSteeringPolicyAttachment, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciDnsSteeringPolicyAttachment>(resource, pH)
