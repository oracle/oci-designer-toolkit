...
export namespace OciHealthChecksHttpMonitorProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciHealthChecksHttpMonitor, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciHealthChecksHttpMonitor>(resource, pH)
