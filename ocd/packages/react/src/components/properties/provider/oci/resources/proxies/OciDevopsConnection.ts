...
export namespace OciDevopsConnectionProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciDevopsConnection, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciDevopsConnection>(resource, pH)
