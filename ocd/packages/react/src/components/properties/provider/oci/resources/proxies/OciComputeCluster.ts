...
export namespace OciComputeClusterProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciComputeCluster, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciComputeCluster>(resource, pH)
