...
export namespace OciCloudBridgeAgentPluginProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciCloudBridgeAgentPlugin, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciCloudBridgeAgentPlugin>(resource, pH)
