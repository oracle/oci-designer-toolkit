...
export namespace OciRedisClusterProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciRedisCluster, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciRedisCluster>(resource, pH)
