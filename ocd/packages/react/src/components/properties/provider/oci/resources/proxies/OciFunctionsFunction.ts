...
export namespace OciFunctionsFunctionProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciFunctionsFunction, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciFunctionsFunction>(resource, pH)
