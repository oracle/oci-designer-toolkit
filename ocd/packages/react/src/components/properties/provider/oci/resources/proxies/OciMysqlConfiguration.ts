...
export namespace OciMysqlConfigurationProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciMysqlConfiguration, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciMysqlConfiguration>(resource, pH)
