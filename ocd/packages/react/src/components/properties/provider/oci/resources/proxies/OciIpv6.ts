...
export namespace OciIpv6Proxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciIpv6, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciIpv6>(resource, pH)
