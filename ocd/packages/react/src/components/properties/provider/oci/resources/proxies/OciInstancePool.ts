...
export namespace OciInstancePoolProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciInstancePool, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciInstancePool>(resource, pH)
