...
export namespace OciObjectLifecyclePolicyProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciObjectLifecyclePolicy, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciObjectLifecyclePolicy>(resource, pH)
