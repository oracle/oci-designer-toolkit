...
export namespace OciLoggingLogProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciLoggingLog, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciLoggingLog>(resource, pH)
