...
export namespace OciArtifactsRepositoryProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciArtifactsRepository, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciArtifactsRepository>(resource, pH)
