...
export namespace OciRouteTableAttachmentProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciRouteTableAttachment, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciRouteTableAttachment>(resource, pH)
