...
export namespace OciPrivateIpProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciPrivateIp, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciPrivateIp>(resource, pH)
