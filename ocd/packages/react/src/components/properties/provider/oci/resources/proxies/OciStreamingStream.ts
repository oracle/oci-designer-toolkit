...
export namespace OciStreamingStreamProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciStreamingStream, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciStreamingStream>(resource, pH)
