...
export namespace OciNetworkFirewallPolicyProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciNetworkFirewallPolicy, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciNetworkFirewallPolicy>(resource, pH)
