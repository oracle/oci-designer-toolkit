...
export namespace OciAutonomousDatabaseBackupProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciAutonomousDatabaseBackup, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciAutonomousDatabaseBackup>(resource, pH)
