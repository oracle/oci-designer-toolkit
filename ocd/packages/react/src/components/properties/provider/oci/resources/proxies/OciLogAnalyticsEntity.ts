...
export namespace OciLogAnalyticsEntityProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciLogAnalyticsEntity, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciLogAnalyticsEntity>(resource, pH)
