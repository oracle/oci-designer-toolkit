...
export namespace OciObjectstorageObjectProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciObjectstorageObject, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciObjectstorageObject>(resource, pH)
