...
export namespace OciComputeCapacityReservationProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciComputeCapacityReservation, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciComputeCapacityReservation>(resource, pH)
