...
export namespace OciAuditConfigurationProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciAuditConfiguration, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciAuditConfiguration>(resource, pH)
