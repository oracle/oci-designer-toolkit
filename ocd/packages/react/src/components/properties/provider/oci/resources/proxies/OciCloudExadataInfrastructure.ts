...
export namespace OciCloudExadataInfrastructureProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciCloudExadataInfrastructure, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciCloudExadataInfrastructure>(resource, pH)
