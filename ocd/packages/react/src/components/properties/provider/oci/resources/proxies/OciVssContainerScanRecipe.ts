...
export namespace OciVssContainerScanRecipeProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciVssContainerScanRecipe, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciVssContainerScanRecipe>(resource, pH)
