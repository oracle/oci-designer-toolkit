...
export namespace OciStackMonitoringResourceProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciStackMonitoringResource, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciStackMonitoringResource>(resource, pH)
