...
export namespace OciCloudGuardDetectorRecipeProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciCloudGuardDetectorRecipe, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciCloudGuardDetectorRecipe>(resource, pH)
