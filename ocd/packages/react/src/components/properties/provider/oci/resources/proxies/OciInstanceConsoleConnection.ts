...
export namespace OciInstanceConsoleConnectionProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciInstanceConsoleConnection, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciInstanceConsoleConnection>(resource, pH)
