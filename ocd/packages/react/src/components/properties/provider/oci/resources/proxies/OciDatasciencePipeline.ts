...
export namespace OciDatasciencePipelineProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciDatasciencePipeline, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciDatasciencePipeline>(resource, pH)
