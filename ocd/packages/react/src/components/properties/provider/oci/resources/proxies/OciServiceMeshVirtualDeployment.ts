...
export namespace OciServiceMeshVirtualDeploymentProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciServiceMeshVirtualDeployment, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciServiceMeshVirtualDeployment>(resource, pH)
