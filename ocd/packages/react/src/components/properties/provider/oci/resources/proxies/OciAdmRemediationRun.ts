...
export namespace OciAdmRemediationRunProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciAdmRemediationRun, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciAdmRemediationRun>(resource, pH)
