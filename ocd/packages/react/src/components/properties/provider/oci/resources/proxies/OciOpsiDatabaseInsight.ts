...
export namespace OciOpsiDatabaseInsightProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciOpsiDatabaseInsight, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciOpsiDatabaseInsight>(resource, pH)
