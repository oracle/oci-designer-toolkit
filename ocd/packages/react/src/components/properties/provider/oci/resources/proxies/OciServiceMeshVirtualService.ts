...
export namespace OciServiceMeshVirtualServiceProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciServiceMeshVirtualService, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciServiceMeshVirtualService>(resource, pH)
