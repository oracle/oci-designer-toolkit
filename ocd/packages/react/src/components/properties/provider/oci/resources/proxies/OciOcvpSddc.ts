...
export namespace OciOcvpSddcProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciOcvpSddc, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciOcvpSddc>(resource, pH)
