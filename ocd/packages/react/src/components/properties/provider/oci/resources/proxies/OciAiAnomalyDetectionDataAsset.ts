...
export namespace OciAiAnomalyDetectionDataAssetProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciAiAnomalyDetectionDataAsset, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciAiAnomalyDetectionDataAsset>(resource, pH)
