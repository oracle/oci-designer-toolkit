...
export namespace OciWebAppFirewallProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciWebAppFirewall, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciWebAppFirewall>(resource, pH)
