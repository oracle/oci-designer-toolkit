...
export namespace OciCloudBridgeAssetSourceProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciCloudBridgeAssetSource, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciCloudBridgeAssetSource>(resource, pH)
