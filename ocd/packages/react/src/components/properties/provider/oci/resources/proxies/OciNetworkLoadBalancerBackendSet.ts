...
export namespace OciNetworkLoadBalancerBackendSetProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciNetworkLoadBalancerBackendSet, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciNetworkLoadBalancerBackendSet>(resource, pH)
