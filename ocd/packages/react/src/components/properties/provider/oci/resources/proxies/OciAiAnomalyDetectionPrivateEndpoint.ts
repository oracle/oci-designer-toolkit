...
export namespace OciAiAnomalyDetectionPrivateEndpointProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciAiAnomalyDetectionPrivateEndpoint, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciAiAnomalyDetectionPrivateEndpoint>(resource, pH)
