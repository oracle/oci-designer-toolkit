...
export namespace OciOpsiPrivateEndpointProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciOpsiPrivateEndpoint, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciOpsiPrivateEndpoint>(resource, pH)
