...
export namespace OciWaasPolicyProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciWaasPolicy, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciWaasPolicy>(resource, pH)
