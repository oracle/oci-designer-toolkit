...
export namespace OciStreamingStreamPoolProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciStreamingStreamPool, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciStreamingStreamPool>(resource, pH)
