...
export namespace OciLogAnalyticsObjectCollectionRuleProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciLogAnalyticsObjectCollectionRule, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciLogAnalyticsObjectCollectionRule>(resource, pH)
