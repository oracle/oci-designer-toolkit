...
export namespace OciDevopsBuildPipelineProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciDevopsBuildPipeline, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciDevopsBuildPipeline>(resource, pH)
