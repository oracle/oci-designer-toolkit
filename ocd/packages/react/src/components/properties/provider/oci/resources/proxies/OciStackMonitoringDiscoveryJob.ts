...
export namespace OciStackMonitoringDiscoveryJobProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciStackMonitoringDiscoveryJob, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciStackMonitoringDiscoveryJob>(resource, pH)
