...
export namespace OciAnalyticsInstanceVanityUrlProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciAnalyticsInstanceVanityUrl, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciAnalyticsInstanceVanityUrl>(resource, pH)
