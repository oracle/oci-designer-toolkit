...
export namespace OciOpensearchClusterProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciOpensearchCluster, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciOpensearchCluster>(resource, pH)
