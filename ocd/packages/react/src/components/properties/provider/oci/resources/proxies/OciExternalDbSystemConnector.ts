...
export namespace OciExternalDbSystemConnectorProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciExternalDbSystemConnector, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciExternalDbSystemConnector>(resource, pH)
