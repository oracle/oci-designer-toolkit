...
export namespace OciAiDocumentProcessorJobProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciAiDocumentProcessorJob, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciAiDocumentProcessorJob>(resource, pH)
