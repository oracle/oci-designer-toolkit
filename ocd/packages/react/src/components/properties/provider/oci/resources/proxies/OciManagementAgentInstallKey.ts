...
export namespace OciManagementAgentInstallKeyProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciManagementAgentInstallKey, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciManagementAgentInstallKey>(resource, pH)
