...
export namespace OciDatabaseMigrationJobProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciDatabaseMigrationJob, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciDatabaseMigrationJob>(resource, pH)
