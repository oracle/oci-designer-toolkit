...
export namespace OciDevopsTriggerProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciDevopsTrigger, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciDevopsTrigger>(resource, pH)
