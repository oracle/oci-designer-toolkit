...
export namespace OciCloudMigrationsMigrationProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciCloudMigrationsMigration, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciCloudMigrationsMigration>(resource, pH)
