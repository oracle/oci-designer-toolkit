...
export namespace OciContainerengineAddonProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciContainerengineAddon, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciContainerengineAddon>(resource, pH)
