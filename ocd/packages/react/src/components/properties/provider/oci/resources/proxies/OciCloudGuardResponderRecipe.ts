...
export namespace OciCloudGuardResponderRecipeProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciCloudGuardResponderRecipe, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciCloudGuardResponderRecipe>(resource, pH)
