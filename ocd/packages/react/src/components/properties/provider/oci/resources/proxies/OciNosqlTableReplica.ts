...
export namespace OciNosqlTableReplicaProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciNosqlTableReplica, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciNosqlTableReplica>(resource, pH)
