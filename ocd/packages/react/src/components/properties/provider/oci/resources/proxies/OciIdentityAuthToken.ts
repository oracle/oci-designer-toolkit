...
export namespace OciIdentityAuthTokenProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciIdentityAuthToken, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciIdentityAuthToken>(resource, pH)
