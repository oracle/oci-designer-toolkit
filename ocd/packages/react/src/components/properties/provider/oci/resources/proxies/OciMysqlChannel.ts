...
export namespace OciMysqlChannelProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciMysqlChannel, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciMysqlChannel>(resource, pH)
