...
export namespace OciWebAppFirewallPolicyProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciWebAppFirewallPolicy, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciWebAppFirewallPolicy>(resource, pH)
