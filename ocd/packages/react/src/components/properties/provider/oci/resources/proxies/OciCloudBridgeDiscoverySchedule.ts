...
export namespace OciCloudBridgeDiscoveryScheduleProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciCloudBridgeDiscoverySchedule, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciCloudBridgeDiscoverySchedule>(resource, pH)
