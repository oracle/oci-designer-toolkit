...
export namespace OciDnsTsigKeyProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciDnsTsigKey, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciDnsTsigKey>(resource, pH)
