...
export namespace OciMonitoringAlarmProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciMonitoringAlarm, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciMonitoringAlarm>(resource, pH)
