...
export namespace OciCloudGuardConfigurationProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciCloudGuardConfiguration, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciCloudGuardConfiguration>(resource, pH)
