...
export namespace OciAnnouncementSubscriptionProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciAnnouncementSubscription, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciAnnouncementSubscription>(resource, pH)
