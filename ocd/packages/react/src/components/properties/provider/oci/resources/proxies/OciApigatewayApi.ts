...
export namespace OciApigatewayApiProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciApigatewayApi, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciApigatewayApi>(resource, pH)
