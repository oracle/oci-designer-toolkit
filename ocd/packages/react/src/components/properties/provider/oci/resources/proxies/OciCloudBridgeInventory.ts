...
export namespace OciCloudBridgeInventoryProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciCloudBridgeInventory, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciCloudBridgeInventory>(resource, pH)
