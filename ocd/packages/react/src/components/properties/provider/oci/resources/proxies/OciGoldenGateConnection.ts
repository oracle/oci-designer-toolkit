...
export namespace OciGoldenGateConnectionProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciGoldenGateConnection, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciGoldenGateConnection>(resource, pH)
