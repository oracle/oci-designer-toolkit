...
export namespace OciCloudMigrationsMigrationPlanProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciCloudMigrationsMigrationPlan, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciCloudMigrationsMigrationPlan>(resource, pH)
