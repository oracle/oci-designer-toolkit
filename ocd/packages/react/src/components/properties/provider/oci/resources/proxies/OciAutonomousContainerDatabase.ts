...
export namespace OciAutonomousContainerDatabaseProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciAutonomousContainerDatabase, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciAutonomousContainerDatabase>(resource, pH)
