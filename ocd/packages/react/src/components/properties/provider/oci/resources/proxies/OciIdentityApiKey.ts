...
export namespace OciIdentityApiKeyProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciIdentityApiKey, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciIdentityApiKey>(resource, pH)
