...
export namespace OciLoadBalancerPathRouteSetProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciLoadBalancerPathRouteSet, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciLoadBalancerPathRouteSet>(resource, pH)
