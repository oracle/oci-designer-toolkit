...
export namespace OciLicenseManagerProductLicenseProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciLicenseManagerProductLicense, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciLicenseManagerProductLicense>(resource, pH)
