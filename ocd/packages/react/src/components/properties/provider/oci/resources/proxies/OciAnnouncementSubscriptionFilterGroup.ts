...
export namespace OciAnnouncementSubscriptionFilterGroupProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciAnnouncementSubscriptionFilterGroup, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciAnnouncementSubscriptionFilterGroup>(resource, pH)
