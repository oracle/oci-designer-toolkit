...
export namespace OciCertificatesCertificateAuthorityProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciCertificatesCertificateAuthority, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciCertificatesCertificateAuthority>(resource, pH)
