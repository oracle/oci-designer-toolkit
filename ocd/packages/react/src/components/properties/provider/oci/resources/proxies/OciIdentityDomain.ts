...
export namespace OciIdentityDomainProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciIdentityDomain, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciIdentityDomain>(resource, pH)
