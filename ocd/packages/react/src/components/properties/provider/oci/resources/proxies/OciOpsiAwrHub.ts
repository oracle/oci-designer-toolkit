...
export namespace OciOpsiAwrHubProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciOpsiAwrHub, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciOpsiAwrHub>(resource, pH)
