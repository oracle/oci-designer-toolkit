...
export namespace OciTagProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciTag, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciTag>(resource, pH)
