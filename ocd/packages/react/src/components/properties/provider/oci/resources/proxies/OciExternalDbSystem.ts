...
export namespace OciExternalDbSystemProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciExternalDbSystem, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciExternalDbSystem>(resource, pH)
