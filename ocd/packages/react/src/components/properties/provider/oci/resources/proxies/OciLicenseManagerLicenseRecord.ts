...
export namespace OciLicenseManagerLicenseRecordProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciLicenseManagerLicenseRecord, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciLicenseManagerLicenseRecord>(resource, pH)
