...
export namespace OciNotificationTopicProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciNotificationTopic, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciNotificationTopic>(resource, pH)
