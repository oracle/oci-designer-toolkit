...
export namespace OciAdmRemediationRecipeProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciAdmRemediationRecipe, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciAdmRemediationRecipe>(resource, pH)
