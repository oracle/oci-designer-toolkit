...
export namespace OciVssHostScanRecipeProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciVssHostScanRecipe, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciVssHostScanRecipe>(resource, pH)
