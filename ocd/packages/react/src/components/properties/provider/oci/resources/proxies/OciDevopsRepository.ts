...
export namespace OciDevopsRepositoryProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciDevopsRepository, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciDevopsRepository>(resource, pH)
