...
export namespace OciWaaPolicyProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciWaaPolicy, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciWaaPolicy>(resource, pH)
