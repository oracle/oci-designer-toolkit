...
export namespace OciDevopsDeployPipelineProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciDevopsDeployPipeline, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciDevopsDeployPipeline>(resource, pH)
