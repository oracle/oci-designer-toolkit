...
export namespace OciExadbVmClusterProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciExadbVmCluster, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciExadbVmCluster>(resource, pH)
