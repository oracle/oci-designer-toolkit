...
export namespace OciCloudMigrationsMigrationAssetProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciCloudMigrationsMigrationAsset, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciCloudMigrationsMigrationAsset>(resource, pH)
