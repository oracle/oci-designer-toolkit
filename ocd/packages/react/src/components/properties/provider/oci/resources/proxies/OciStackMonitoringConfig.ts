...
export namespace OciStackMonitoringConfigProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciStackMonitoringConfig, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciStackMonitoringConfig>(resource, pH)
