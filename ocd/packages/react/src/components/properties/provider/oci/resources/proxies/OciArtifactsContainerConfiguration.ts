...
export namespace OciArtifactsContainerConfigurationProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciArtifactsContainerConfiguration, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciArtifactsContainerConfiguration>(resource, pH)
