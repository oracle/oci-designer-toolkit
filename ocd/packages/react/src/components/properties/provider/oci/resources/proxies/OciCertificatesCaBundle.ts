...
export namespace OciCertificatesCaBundleProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciCertificatesCaBundle, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciCertificatesCaBundle>(resource, pH)
