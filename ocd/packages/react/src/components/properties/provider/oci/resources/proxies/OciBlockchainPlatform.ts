...
export namespace OciBlockchainPlatformProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciBlockchainPlatform, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciBlockchainPlatform>(resource, pH)
