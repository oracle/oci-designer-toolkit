...
export namespace OciCloudMigrationsTargetAssetProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciCloudMigrationsTargetAsset, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciCloudMigrationsTargetAsset>(resource, pH)
