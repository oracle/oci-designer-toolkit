...
export namespace OciPluggableDatabaseProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciPluggableDatabase, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciPluggableDatabase>(resource, pH)
