...
export namespace OciHealthChecksHttpProbeProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciHealthChecksHttpProbe, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciHealthChecksHttpProbe>(resource, pH)
