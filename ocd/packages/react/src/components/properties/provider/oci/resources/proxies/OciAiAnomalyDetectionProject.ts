...
export namespace OciAiAnomalyDetectionProjectProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciAiAnomalyDetectionProject, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciAiAnomalyDetectionProject>(resource, pH)
