...
export namespace AzureOracleExadataInfrastructureProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.AzureOracleExadataInfrastructure, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.AzureOracleExadataInfrastructure>(resource, pH)
