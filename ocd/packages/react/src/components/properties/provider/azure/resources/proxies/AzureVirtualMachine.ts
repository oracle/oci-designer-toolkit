...
export namespace AzureVirtualMachineProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.AzureVirtualMachine, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.AzureVirtualMachine>(resource, pH)
