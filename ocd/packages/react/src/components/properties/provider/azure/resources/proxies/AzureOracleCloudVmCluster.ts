...
export namespace AzureOracleCloudVmClusterProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.AzureOracleCloudVmCluster, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.AzureOracleCloudVmCluster>(resource, pH)
