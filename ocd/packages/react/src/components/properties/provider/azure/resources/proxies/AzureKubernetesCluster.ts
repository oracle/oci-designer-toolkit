...
export namespace AzureKubernetesClusterProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.AzureKubernetesCluster, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.AzureKubernetesCluster>(resource, pH)
