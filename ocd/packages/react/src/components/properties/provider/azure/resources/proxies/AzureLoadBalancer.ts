...
export namespace AzureLoadBalancerProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.AzureLoadBalancer, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.AzureLoadBalancer>(resource, pH)
