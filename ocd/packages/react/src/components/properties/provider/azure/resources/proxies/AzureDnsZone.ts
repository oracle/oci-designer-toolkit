...
export namespace AzureDnsZoneProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.AzureDnsZone, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.AzureDnsZone>(resource, pH)
