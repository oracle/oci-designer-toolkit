...
export namespace GoogleComputeNetworkProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.GoogleComputeNetwork, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.GoogleComputeNetwork>(resource, pH)
