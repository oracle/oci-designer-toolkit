...
export namespace OciDrgProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciDrg, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciDrg>(resource, pH)
