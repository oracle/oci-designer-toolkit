...
export namespace OciLocalPeeringGatewayProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciLocalPeeringGateway, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciLocalPeeringGateway>(resource, pH)
