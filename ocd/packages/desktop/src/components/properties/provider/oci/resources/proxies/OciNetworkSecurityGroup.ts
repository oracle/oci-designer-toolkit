...
export namespace OciNetworkSecurityGroupProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciNetworkSecurityGroup, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciNetworkSecurityGroup>(resource, pH)
