...
export namespace OciPolicyProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciPolicy, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciPolicy>(resource, pH)
