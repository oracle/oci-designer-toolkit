...
export const OciSecurityList = ({ ocdDocument, setOcdDocument, resource }: ResourceProperties): JSX.Element => {
    ...
    return (
        <AutoGenerated.OciSecurityList ocdDocument={ocdDocument} setOcdDocument={(ocdDocument:OcdDocument) => setOcdDocument(ocdDocument)} resource={resource} configs={configs} additionalElements={additionalElements} />
    )
}
