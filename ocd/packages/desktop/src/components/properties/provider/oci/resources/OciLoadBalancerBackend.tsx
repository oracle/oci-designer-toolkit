...
export const OciLoadBalancerBackend = ({ ocdDocument, setOcdDocument, resource, summaryTitle, onDelete }: ResourceProperties): JSX.Element => {
    ...
    return (
        <AutoGenerated.OciLoadBalancerBackend ocdDocument={ocdDocument} setOcdDocument={(ocdDocument:OcdDocument) => setOcdDocument(ocdDocument)} resource={proxyResource} configs={configs}summaryTitle={summaryTitle} onDelete={onDelete} />
    )
}
