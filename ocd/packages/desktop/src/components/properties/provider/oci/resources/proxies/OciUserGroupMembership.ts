...
export namespace OciUserGroupMembershipProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciUserGroupMembership, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciUserGroupMembership>(resource, pH)
