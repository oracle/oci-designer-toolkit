...
export namespace OciDbSystemProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciDbSystem, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciDbSystem>(resource, pH)
