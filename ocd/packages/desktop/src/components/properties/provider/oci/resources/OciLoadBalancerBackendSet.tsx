...
export const OciLoadBalancerBackendSet = ({ ocdDocument, setOcdDocument, resource }: ResourceProperties): JSX.Element => {
    ...
    // const proxyResource = OciLoadBalancerBackendSetProxy.proxyResource(ocdDocument, resource)
    return (
        <AutoGenerated.OciLoadBalancerBackendSet ocdDocument={ocdDocument} setOcdDocument={(ocdDocument:OcdDocument) => setOcdDocument(ocdDocument)} resource={proxyResource} configs={configs} additionalElements={additionalElements} />
    )
}
