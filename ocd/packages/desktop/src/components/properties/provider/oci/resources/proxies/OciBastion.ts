...
export namespace OciBastionProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciBastion, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciBastion>(resource, pH)
