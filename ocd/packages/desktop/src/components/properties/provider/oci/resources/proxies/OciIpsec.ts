...
export namespace OciIpsecProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciIpsec, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciIpsec>(resource, pH)
