...
export const OciDhcpOptions = ({ ocdDocument, setOcdDocument, resource }: ResourceProperties): JSX.Element => {
    ...
    return (
        <AutoGenerated.OciDhcpOptions ocdDocument={ocdDocument} setOcdDocument={(ocdDocument:OcdDocument) => setOcdDocument(ocdDocument)} resource={resource} configs={configs} additionalElements={additionalElements} />
    )
}
