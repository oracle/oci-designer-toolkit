...
export namespace OciAnalyticsInstanceProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciAnalyticsInstance, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciAnalyticsInstance>(resource, pH)
