...
export namespace OciFileSystemExportSetProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciFileSystemExportSet, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciFileSystemExportSet>(resource, pH)
