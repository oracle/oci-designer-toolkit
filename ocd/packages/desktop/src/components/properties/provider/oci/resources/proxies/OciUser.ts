...
export namespace OciUserProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciUser, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciUser>(resource, pH)
