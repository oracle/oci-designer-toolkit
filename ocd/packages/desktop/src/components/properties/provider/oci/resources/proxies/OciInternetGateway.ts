...
export namespace OciInternetGatewayProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciInternetGateway, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciInternetGateway>(resource, pH)
