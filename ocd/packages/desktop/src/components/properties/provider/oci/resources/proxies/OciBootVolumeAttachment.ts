...
export namespace OciBootVolumeAttachmentProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.OciBootVolumeAttachment, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.OciBootVolumeAttachment>(resource, pH)
