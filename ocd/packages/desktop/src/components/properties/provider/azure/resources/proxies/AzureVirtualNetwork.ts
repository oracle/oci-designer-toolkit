...
export namespace AzureVirtualNetworkProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.AzureVirtualNetwork, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.AzureVirtualNetwork>(resource, pH)
