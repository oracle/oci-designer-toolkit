...
export namespace AzureContainerRegistryProxy {
    ...
    export function proxyResource(ocdDocument: OcdDocument, resource: Model.AzureContainerRegistry, ocdCache: OcdCacheData) {
        const pH = proxyHandler(ocdDocument, ocdCache)
        const proxyResource = new Proxy<Model.AzureContainerRegistry>(resource, pH)
