...
export const OciLoadBalancerBackendSet = ({ ocdDocument, ociResources, selected }: OciTabularResourceProps): JSX.Element => {
    ...
    return (
        <OcdTabularContents 
            ...
            key={'OciLoadBalancerBackendSetTabularContents'}
        />
    )
}
