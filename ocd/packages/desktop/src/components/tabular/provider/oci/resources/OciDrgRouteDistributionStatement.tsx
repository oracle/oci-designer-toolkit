...
export const OciDrgRouteDistributionStatement = ({ ocdDocument, ociResources, selected }: OciTabularResourceProps): JSX.Element => {
    ...
    return (
        <OcdTabularContents 
            ...
            key={'OciDrgRouteDistributionStatementTabularContents'}
        />
    )
}
