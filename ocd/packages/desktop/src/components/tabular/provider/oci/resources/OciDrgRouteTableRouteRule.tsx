...
export const OciDrgRouteTableRouteRule = ({ ocdDocument, ociResources, selected }: OciTabularResourceProps): JSX.Element => {
    ...
    return (
        <OcdTabularContents 
            ...
            key={'OciDrgRouteTableRouteRuleTabularContents'}
        />
    )
}
