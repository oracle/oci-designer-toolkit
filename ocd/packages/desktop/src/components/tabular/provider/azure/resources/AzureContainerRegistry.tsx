...
export const AzureContainerRegistry = ({ ocdDocument, azureResources, selected }: AzureTabularResourceProps): JSX.Element => {
    ...
    return (
        <OcdTabularContents 
            ...
            key={'AzureContainerRegistryTabularContents'}
        />
    )
}
