            ...
            <ul>
                <li className='ocd-console-toolbar-dropdown-item' onClick={onToggleMenuClick}>
                    ...
                    <ul className={`${menuVisible ? 'show slide-up' : 'hidden'}`}>
                        <li className='ocd-dropdown-menu-item ocd-mouseover-highlight'><div><input type='checkbox' onChange={displayGridOnChange} ref={cbRef} checked={activePage.grid}/>Display Grid</div></li>
