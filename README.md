# Oracle Cloud Infrastructure Designer and Visualisation Toolkit [0.61.0](CHANGELOG.md#version-0.61.0)

Full Release Details Can Found [0.61.0 Release](https://github.com/oracle/oci-designer-toolkit/releases/tag/v0.61.0).

**OKIT - Open Cloud Designer** Public Beta is now Available see [0.61.0 Release](https://github.com/oracle/oci-designer-toolkit/releases/tag/v0.61.0) for details.
_____
...
[Changes for the current release (0.61.0) are documented here.](CHANGELOG.md#version-0.61.0)
