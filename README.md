# Oracle Cloud Infrastructure Designer and Visualisation Toolkit [0.38.0](CHANGELOG.md#version-0.38.0)
...
[Changes for the current release (0.38.0) are documented here.](CHANGELOG.md#version-0.38.0)
