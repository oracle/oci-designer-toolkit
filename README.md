# Oracle Cloud Infrastructure Designer and Visualisation Toolkit [0.37.0](CHANGELOG.md#version-0.37.0)
...
[Changes for the current release (0.37.0) are documented here.](CHANGELOG.md#version-0.37.0)
