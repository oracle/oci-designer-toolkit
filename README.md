# Oracle Cloud Infrastructure Designer and Visualisation Toolkit [0.50.1](CHANGELOG.md#version-0.50.1)
...
[Changes for the current release (0.50.1) are documented here.](CHANGELOG.md#version-0.50.1)
