# Oracle Cloud Infrastructure Designer and Visualisation Toolkit [0.46.0](CHANGELOG.md#version-0.46.0)
...
[Changes for the current release (0.46.0) are documented here.](CHANGELOG.md#version-0.46.0)
