# Oracle Cloud Infrastructure Designer and Visualisation Toolkit [0.32.1](CHANGELOG.md#version-0.32.1)
...
[Changes for the current release (0.32.1) are documented here.](CHANGELOG.md#version-0.32.1)
