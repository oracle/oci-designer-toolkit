# Oracle Cloud Infrastructure Designer and Visualisation Toolkit [0.36.0](CHANGELOG.md#version-0.36.0)
...
[Changes for the current release (0.36.0) are documented here.](CHANGELOG.md#version-0.36.0)
