# Oracle Cloud Infrastructure Designer and Visualisation Toolkit [0.31.1](CHANGELOG.md#version-0.31.1)
...
[Changes for the current release (0.31.1) are documented here.](CHANGELOG.md#version-0.31.1)
