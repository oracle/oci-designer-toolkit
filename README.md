# Oracle Cloud Infrastructure Designer and Visualisation Toolkit [0.54.5](CHANGELOG.md#version-0.54.5)
...
[Changes for the current release (0.54.5) are documented here.](CHANGELOG.md#version-0.54.5)
