# Oracle Cloud Infrastructure Designer and Visualisation Toolkit [0.59.0](CHANGELOG.md#version-0.59.0)
...
[Changes for the current release (0.59.0) are documented here.](CHANGELOG.md#version-0.59.0)
