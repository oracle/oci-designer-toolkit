...
const provider: common.ConfigFileAuthenticationDetailsProvider = new common.ConfigFileAuthenticationDetailsProvider(configurationFilePath, profile);
...
//    await usersByFreeformTagAndValue("okit_version", "0.38.0");
    ...
    */
    ...
    const listCompartmentsReq: identity.requests.ListCompartmentsRequest = {compartmentId: compartmentId, compartmentIdInSubtree: true}
    ...
    const listTablesRequest: nosql.requests.ListTablesRequest = {compartmentId: compartmentId};
